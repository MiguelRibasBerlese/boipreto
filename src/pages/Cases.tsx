    ...
    <div className="pt-32 pb-24">
        ...
        <div className="flex flex-col md:flex-row gap-12 items-end justify-between">
          <div className="md:w-2/3">
            ...
            <h1 className="text-6xl md:text-8xl font-headline italic leading-[1.1] mb-8">
              Contra dados, não há <span className="text-primary">intuição</span> que vença.
            </h1>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-5 order-2 lg:order-1">
            <div className="sticky top-40">
              <h2 className="text-4xl font-headline italic mb-4">Fazenda Nova Era, TO</h2>
              <p className="text-primary/70 font-label text-[10px] uppercase tracking-[0.25em] mb-8">Gestão Intensiva de Ciclo Completo</p>
              
              <div className="space-y-6">
                <div className="p-6 bg-surface-container rounded border-l-2 border-primary">
                  <span className="text-primary text-[10px] uppercase font-label font-bold tracking-widest">O Desafio</span>
                  <p className="mt-2 text-on-surface/80 font-light text-sm">Baixa rentabilidade por hectare devido ao manejo extensivo e falta de controle de custos variáveis.</p>
                </div>
                
                <div className="grid grid-cols-2 gap-4">
                  <div className="p-6 bg-surface-container rounded border border-white/5">
                    <span className="text-primary font-bold text-3xl font-body">+24%</span>
                    <p className="text-primary/60 text-[9px] uppercase font-label mt-1 tracking-widest">Margem Líquida</p>
                  </div>
                  <div className="p-6 bg-surface-container rounded border border-white/5">
                    <span className="text-on-surface font-bold text-3xl font-body">R$ 1.8k</span>
                    <p className="text-primary/60 text-[9px] uppercase font-label mt-1 tracking-widest">Lucro Médio/HA</p>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pointer-events-auto">
                  <div className="bg-black/90 backdrop-blur-xl p-6 rounded border border-primary/30">
                    <div className="flex justify-between items-center mb-6">
                      <h3 className="font-label text-[10px] uppercase tracking-widest text-primary font-bold">Evolução ROI (%)</h3>
                      <TrendingUp className="text-primary w-4 h-4" />
                    </div>
                    <div className="h-32 flex items-end gap-2 px-2">
                      <div className="w-full bg-white/5 h-[30%] rounded-t-sm relative group/bar"></div>
                  ...
                  <div className="bg-black p-6 rounded border border-white/5">
                    <h3 className="font-label text-[10px] uppercase tracking-widest text-primary/80 mb-4 font-bold">Performance HA</h3>
                    <div className="space-y-4">
                      <div className="flex justify-between items-end">
                        <span className="text-[10px] text-on-surface-variant opacity-50 font-label uppercase">Investimento</span>
                        <span className="text-xs font-body">R$ 850,00</span>
                      </div>
                      <div className="w-full bg-white/5 h-[2px] overflow-hidden">
                        <div className="bg-white/20 h-full w-[65%]"></div>
                      </div>
                      <div className="flex justify-between items-end">
                        <span className="text-[10px] text-on-surface-variant opacity-50 font-label uppercase">Retorno Líquido</span>
                        <span className="text-xs font-body text-primary font-bold">R$ 1.840,00</span>
                      </div>
                      <div className="w-full bg-white/5 h-[2px] overflow-hidden">
      ...
      <section className="bg-surface py-24 relative overflow-hidden border-y border-white/5">
        <div className="px-8 max-w-7xl mx-auto relative z-10">
          <div className="mb-16">
            <h2 className="text-5xl font-headline italic mb-4 text-primary">Aumento de Capacidade de Suporte</h2>
            <p className="text-on-surface-variant max-w-2xl font-body leading-relaxed">Otimização de pastagens e suplementação estratégica para maximizar a Unidade Animal por Hectare através de monitoramento intensivo.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="md:col-span-1 bg-surface-container p-8 rounded border border-white/5 flex flex-col justify-between">
              <div>
                <span className="inline-block py-1 px-3 rounded bg-white/5 text-on-surface-variant opacity-40 text-[9px] font-label uppercase mb-6 tracking-widest">Status: Anterior</span>
                <div className="text-6xl font-headline italic mb-2 opacity-40">0.8</div>
                <div className="text-on-surface-variant opacity-40 font-label uppercase text-[9px] tracking-[0.2em]">UA / Hectare</div>
              </div>
              <p className="text-[11px] text-on-surface-variant opacity-40 mt-10 italic leading-relaxed">\"Pastagem degradada com baixa lotação e dependência extrema do clima.\"</p>
            </div>
            ...
            <div className="md:col-span-1 bg-surface-container-high p-8 rounded border border-primary/40 flex flex-col justify-between relative overflow-hidden">
              <div>
                <span className="inline-block py-1 px-3 rounded bg-primary/20 text-primary text-[9px] font-label uppercase mb-6 tracking-widest font-bold border border-primary/20">Status: Otimizado</span>
                <div className="text-6xl font-headline italic text-primary mb-2">1.4</div>
                <div className="text-primary/70 font-label uppercase text-[9px] tracking-[0.2em]">UA / Hectare</div>
              </div>
              <p className="text-[11px] text-on-surface mt-10 leading-relaxed font-light">Implementação de pastejo rotacionado e correção de solo sistemática com foco em solo vivo.</p>
            </div>
            ...
            <div className="md:col-span-1 bg-black p-8 rounded border border-white/5 flex flex-col justify-between">
              <div className="space-y-6">
                <div>
                  <h4 className="font-label text-[9px] uppercase text-primary/60 mb-3 tracking-widest">Ganho de Carcaça</h4>
                  <div className="flex items-center gap-4">
                    ...
                    <span className="font-body text-[10px] font-bold text-primary">+75%</span>
                  </div>
                </div>
                <div>
                  <h4 className="font-label text-[9px] uppercase text-primary/60 mb-3 tracking-widest">Eficiência Hídrica</h4>
                  <div className="flex items-center gap-4">
                    <div className="flex-1 bg-white/5 h-[2px] overflow-hidden">
                      <div className="bg-primary/60 h-full w-[92%]"></div>
                    </div>
                    <span className="font-body text-[10px] font-bold text-primary/60">+12%</span>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-8 pt-8 border-t border-white/5">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-[9px] font-label text-primary/60 uppercase tracking-widest">Redução de Custos</div>
                    <div className="text-sm font-bold text-on-surface">18% Global</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="px-8 max-w-5xl mx-auto py-32 text-center">
        <h3 className="text-4xl md:text-6xl font-headline italic mb-12">Sua fazenda pode render mais. <br/><span className="text-primary">Deixe os números provarem.</span></h3>
