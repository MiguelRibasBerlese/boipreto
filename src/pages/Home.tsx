...
export default function Home() {
  ...
  return (
    <div className="pt-20 md:pt-24">
      ...
      <section className="relative min-h-[95vh] flex items-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-8 relative z-10">
          ...
          >
            ...
            <h1 className="font-logo text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-bold leading-[1] text-on-surface mb-6 md:mb-8 tracking-tighter">
              {hero.headline} <span className="text-primary">{hero.headlineHighlight}</span>
            </h1>
            <p className="font-body text-on-surface-variant text-lg md:text-xl lg:text-2xl max-w-2xl mb-8 md:mb-12 leading-relaxed opacity-80">
              {hero.subheading}
            </p>
            <div className="flex flex-col sm:flex-row gap-4 md:gap-6">
              <Link
                to="/contato"
                className="bg-primary text-on-primary px-8 md:px-10 py-4 md:py-5 font-label font-bold uppercase tracking-[0.2em] text-[10px] hover:bg-primary/90 hover:scale-105 hover:brightness-110 transition-all duration-300 shadow-2xl cursor-pointer text-center"
              >
                {hero.ctaPrimary}
              </Link>
              <Link
                to="/servicos"
                className="border border-primary/30 text-primary px-8 md:px-10 py-4 md:py-5 font-label font-bold uppercase tracking-[0.2em] text-[10px] hover:bg-primary/10 hover:scale-105 hover:brightness-110 transition-all duration-300 cursor-pointer text-center"
              >
                {hero.ctaSecondary}
              </Link>
            </div>
        ...
        {/* Overlapping Data Widget — desktop only */}
      ...
      {/* Problem Section */}
      <section className="py-16 md:py-40 bg-background border-y border-primary/5">
        <div className="container mx-auto px-4 md:px-8">
          <div className="text-center max-w-3xl mx-auto mb-12 md:mb-24">
            <h2 className="font-logo text-3xl md:text-5xl font-bold mb-6 tracking-tight">{problems.sectionTitle}</h2>
            <p className="text-on-surface-variant font-body text-base md:text-lg opacity-60">{problems.sectionSubtitle}</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-0 border border-primary/10">
            <div className="group bg-surface p-8 md:p-12 border-b md:border-b-0 md:border-r border-primary/10 hover:bg-primary/5 transition-all duration-700">
              <div className="mb-8 md:mb-10">
                <Landmark className="text-primary w-10 h-10 font-light" />
              </div>
              <h3 className="font-headline text-xl md:text-2xl mb-4 md:mb-5 italic text-on-surface">{problems.cards[0].title}</h3>
            ...
            <div className="group bg-surface p-8 md:p-12 border-b md:border-b-0 md:border-r border-primary/10 hover:bg-primary/5 transition-all duration-700">
              ...
              <h3 className="font-headline text-xl md:text-2xl mb-4 md:mb-5 italic text-on-surface">{problems.cards[1].title}</h3>
              <p className="font-body text-on-surface-variant leading-relaxed text-base opacity-70">{problems.cards[1].description}</p>
            </div>

            <div className="group bg-surface p-8 md:p-12 hover:bg-primary/5 transition-all duration-700">
              <div className="mb-8 md:mb-10">
                <LineChart className="text-primary w-10 h-10 font-light" />
              </div>
              <h3 className="font-headline text-xl md:text-2xl mb-4 md:mb-5 italic text-on-surface">{problems.cards[2].title}</h3>
      ...
      {/* Solution Section */}
      <section className="py-16 md:py-40 bg-[#050505] overflow-hidden">
        <div className="container mx-auto px-4 md:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 md:gap-16 items-center">
            <div className="lg:col-span-5 flex flex-col justify-center">
              ...
              <h2 className="font-headline text-4xl md:text-6xl mb-8 md:mb-10 leading-[1.1] tracking-tighter">
                {solution.headline} <span className="italic text-primary">{solution.headlineHighlight}</span>.
              </h2>
              <p className="font-body text-on-surface-variant text-lg md:text-xl mb-8 md:mb-10 leading-relaxed opacity-80">
                {solution.description}
              </p>
              <div className="space-y-5 md:space-y-6 mb-10 md:mb-12">
                {solution.pillars.map((item) => (
                  <div key={item} className="flex items-center gap-4 group">
                    <div className="w-2 h-2 bg-primary transition-all group-hover:w-4 shrink-0"></div>
            ...
            <div className="lg:col-span-7 grid grid-cols-2 gap-3 md:gap-6">
              ...
              <div className="aspect-square bg-[#141414] p-6 md:p-10 flex flex-col justify-end border border-primary/10">
                <BarChart3 className="text-primary w-8 md:w-12 h-8 md:h-12 mb-4 md:mb-6 font-light" />
                <h4 className="font-headline text-xl md:text-2xl italic mb-2 md:mb-3 text-on-surface">{solution.dataCard.title}</h4>
      ...
      {/* Final CTA */}
      <section className="py-16 md:py-40 relative overflow-hidden border-t border-primary/10">
