...
/**
 * Página de serviços — lista os três produtos da consultoria em cards com grid responsivo
 * e exibe uma seção showcase com quote de posicionamento e CTAs de conversão.
 */
    ...
    <div className="pt-32">
          ...
          {SERVICES_DATA.map((service, idx) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="font-logo font-bold text-3xl mb-4 text-on-surface">{service.title}</h3>
                <div className="mb-8">
      ...
      <section className="px-8 max-w-7xl mx-auto mb-32">
        <div className="flex flex-col md:flex-row items-center gap-16">
          <div className="md:w-1/2 relative pb-10 pr-10">
            ...
            <div className="absolute -bottom-8 -right-8 bg-surface-container-highest p-6 rounded z-20 hidden md:block border border-primary/20 shadow-xl">
              <p className="font-headline italic text-2xl text-primary">{showcase.quote}</p>
              <p className="font-body text-[10px] uppercase tracking-widest text-on-surface-variant mt-2">{showcase.quoteAuthor}</p>
            </div>
          </div>
          <div className="md:w-1/2">
            <h2 className="font-headline text-4xl md:text-5xl mb-6">{showcase.title}</h2>
